            ...
            <div className="">
                ...
                <div className="rui-99hme _2VzDG" tabIndex="0" role="button">
                  <div className="rui-oN78c _1I7gi">
                    <div className="_1P3Se">
                      <div className="slick-slider _28lFW slick-initialized" dir="ltr">
                        ...
                        <div className="slick-slider _18EnX slick-initialized">
                          <div className="slick-list">
                            <div className="slick-track" style={{ width: '50%', left: '0%' }}>
                              ...
                              <div  data-index="0" className="slick-slide slick-active slick-current" tabIndex="-1" aria-hidden="false" style={{ outline: 'none', width: '25%' }}>
                                <div>
                                  <div className="_2Ci7P" tabIndex="-1" style={{ width: '100%', display: 'inline-block' }}>
                                    <button className="_2ToZN lf0Cx _3V0eE" value="0" ></button>
                                  </div>
                                </div>
                              </div>
                              <div  data-index="0" className="slick-slide slick-active slick-current" tabIndex="-1" aria-hidden="false" style={{ outline: 'none', width: '25%' }}>
                      ...
                      <div data-aut-id="itemParams" className="_3B4o-">
                        <div className="_3nSm3">
                          <div className="_1O2tT">
                            <div className="_2oHc_"><span className="_3V4pD" data-aut-id="key_make">postbrand</span><span className="B6X7c" data-aut-id="value_make">post title</span></div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="rui-jIycK rui-tOTz6 rui-EY2Ik rui-RVnVw rui-ZvM8x rui-VAm0G">
                <div className="rui-99hme _7qT_t" tabIndex="0" role="button">
                  <div className="rui-oN78c">
                    <section className="_8S0h4">
                      <span data-aut-id="itemPrice" className="T8y-z">₹ 222price</span>
                      <h1 data-aut-id="itemTitle" className="_1hJph">title</h1>
                      <h4 data-aut-id="itemTitle" className="_1hJph">description</h4>
                      <div className="_3dpp8">
                        <div data-aut-id="itemLocation" className="_3ipDN">
                          <div className="_3Uj8e"><span className="_1RkZP">location</span></div>
                        </div>
                        <div data-aut-id="itemCreationDate" className="_3n70Q">
                          {/* <span>Yesterday</span> */}
                        </div>
                ...
                <div className="rui-99hme _3faUP" tabIndex="0" role="button">
                  <div className="rui-oN78c">
                    ...
                    <div className="_2tgkn">
                      <div className="eHFQs">nameee</div>
                      <h6 className='mt-2'>Contact : 989898888 mobile</h6>
